...
* Look at open issues tagged with ["help wanted"](https://github.com/divyasharma/expert_umbrella/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) and ["good first issue"](https://github.com/divyasharma/expert_umbrella/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
* Look at the [contributing guide in our documentation](https://divyasharma.github.io/expert_umbrella/contributing)

## Licensing

By contributing to expert_umbrella, i.e. through opening a pull request, you represent that your contributions are your own original work and that you have the right to license them, and you agree that your contributions are licensed under the expert_umbrella.

## Reporting bugs and requesting features

You can open an issue on GitHub to report bugs or request new expert_umbrella features.
Follow these links to submit your issue:

- [Report bugs or other problems while running expert_umbrella](https://github.com/divyasharma/expert_umbrella/issues/new?template=BUG-REPORT.yml).
If reporting an error, please include a full traceback in your issue.

- [Request features that expert_umbrella does not already include](https://github.com/divyasharma/expert_umbrella/issues/new?template=FEATURE-REQUEST.yml).

- [Report missing or inconsistent information in our documentation](https://github.com/divyasharma/expert_umbrella/issues/new?template=DOCS.yml).

- [Any other issue](https://github.com/divyasharma/expert_umbrella/issues/new).

## Submitting changes

Look at the [development guide in our documentation](https://divyasharma.github.io/expert_umbrella/contributing) for information on how to get set up for development.
...
6. On GitHub, create a new [pull request](https://github.com/divyasharma/expert_umbrella/pull/new/main) from the feature branch.
